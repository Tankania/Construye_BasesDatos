...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-10-2022 a las 03:29:38
...
INSERT INTO `asignatura` (`clave`, `nombre`, `horas_semanales`, `horas_totales`) VALUES
('111', 'Calculo Integral', 5, '0'),
('112', 'Ingles v', 5, NULL),
('113', 'Fisica II', 4, NULL),
('114', 'Ciencia,Tecnologia,Sociedad y ', 4, NULL),
...
('Administracion en re', 'mixto', NULL),
...
('12121212121212', 'Carlos Samael', 'Aguayo Sanatana', '17', '4181095552', 'aqui mismo', '5PV'),
('12345676543212', 'Cynthia Janeth', 'Granados Estrada', '17', '4151388514', 'Rio LAja', '5PV'),
('20311050750483', 'Tania', 'Alvarez Anguiano', '17', '4181774420', 'Adolfo Lopez Mateos #3', '5PV');
...
('20311050750483', '142', '2022-10-18', 5, 10, 1),
('20311050750483', '143', '2022-10-18', 5, 10, 1);
...
('5AM', 'Matutino', NULL, NULL, 'Administracion en re'),
('5AV', 'Vespertino', NULL, NULL, 'Administracion en re'),
